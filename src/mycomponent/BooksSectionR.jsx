...
const BooksSectionR = ({ title, description, bgtitle, colorscheme, booksarray, query }) => {
    ...
    return (
        <div className="BooksSectionR">
        <div className="HeroBookLR" style={LeftHeroStyle}>
