...
function Mainframe({ activeTab }) {
    ...
    let BooksData = [
        {id : 1, type : 'CollegeBooks', title : '', coverimg : '', description : ''},
        {id : 2, type : 'Novel', title : '', coverimg : '', description : ''},
        {id : 3, type : 'CollegeBooks', title : '', coverimg : '', description : ''},
        {id : 4, type : 'CollegeBooks', title : '', coverimg : '', description : ''},
        {id : 5, type : 'CollegeBooks', title : '', coverimg : '', description : ''},
        {id : 6, type : 'CollegeBooks', title : '', coverimg : '', description : ''},
    ];
